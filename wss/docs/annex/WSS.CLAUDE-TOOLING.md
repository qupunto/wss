...
| `toggle` | `wss-skill-levels.sh` | step 1's level table in one deterministic call — the two settings reads, the two tree enumerations, the merge — rather than a re-derivation each invocation |
